...
<html lang="en">
@php
    use App\Helpers\AdminPermissionHelper;
@endphp
<head>
    <meta charset="UTF-8">
...
<body class="font-sans antialiased bg-[#F3F9FF] text-slate-900">
    ...
    <aside class="fixed h-screen w-64 bg-white border-r border-slate-200 flex flex-col z-10 overflow-y-auto shadow-sm">
        ...
        @if(AdminPermissionHelper::can('manage_profile'))
        ...
        @if(!isset($appSettings['show_portfolio_sections']) || $appSettings['show_portfolio_sections'] === '1')
            @if(AdminPermissionHelper::can('manage_sections'))
            ...
            @endif
        @endif
        @if(AdminPermissionHelper::can('manage_services'))
        ...
        @endif
        @if(AdminPermissionHelper::can('manage_education'))
        ...
        @endif
        @if(AdminPermissionHelper::can('manage_blogs'))
        ...
        @endif
        @if(AdminPermissionHelper::can('manage_reviews'))
        ...
        @if(AdminPermissionHelper::can('manage_clinics'))
        ...
        @endif
        @if(AdminPermissionHelper::can('view_profile'))
        ...
        @endif
        @if(AdminPermissionHelper::can('manage_schedules'))
        ...
        @endif
        @if(AdminPermissionHelper::can('manage_appointments'))
        ...
        @endif
        @if(AdminPermissionHelper::can('manage_medicines'))
        ...
        @endif
        @if(AdminPermissionHelper::can('manage_prescriptions'))
        ...
        @endif
        @if(AdminPermissionHelper::can('manage_roles'))
